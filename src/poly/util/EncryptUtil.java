...
public class EncryptUtil {
	 ...
	 * 
	 * 일반적인 암호화 알고리즘 SHA-256을 통해서만 암호화 시킬 경우, 암호화 된 값만 쓰고 일반적인 비밀번호에 대한 값을 
	 * 쉽게 예측이 가능함 따라서ㅡ 암호화 할 때 암호화 되는 값에 추가적인 문자열을 붙여서 함꼐 함호화를 진행함.
	 */
	...
	// 초기 백터(16바이트 크기를 가지며, 16바이트 단위로 암호화시킴. 암호화 할 총 길이가 16바이트가 되지 못하면 뒤에 추가하는 바이트)
	final static byte[] ivBytes = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
	
	// AES128-CBC 암호화 알고리즘에 사용되는 초기 백터와 암호화 키
	final static String key = "PolyTechnic12345"; // 16글자(영문 1글자당 1바이트)
	 ...
	 * AES128 CBC 암호화 함수
	 * 
	 * 128은 암호화 키 길이를 의미함 128비트 = 16바이트
	 */
